...
and am also looking for a PhD for Fall 2021.}
%
%
\section{Education}
...
supramolecular chemistry, chemobiology, and chemistry for optoelectronics.%
}
%
\vspace{5mm}
%
\cventry{2018--2020}{(M1) M.Sc. in Chemistry}%
{Université Paris-Sud}{Orsay (91)}{High Honours}%
{Organic Chemistry specialization}

\cventry{2017--2018}{B.Sc. in Chem. (Physics minor)}%
...
C, %
Bash\includegraphics[height=2\fontcharht\font`\B]{bash_logo.png}%
}{Basics}
